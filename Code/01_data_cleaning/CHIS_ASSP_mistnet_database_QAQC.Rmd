...
This document is divided into two categories: Banding QAQC and CPUE QAQC. Amelia DuVall conducted QAQC on the Banding data and Emma Kelsey conducted QAQC on the CPUE metadata.
The exploration of most variables ends with code (commented out) to export flagged data for manual review.
...
```{r readin}
captures.raw <- read.csv(here("Data", "raw_data", "captures.csv"), na.strings = c("NA", "ND"))
cpue.raw <- read.csv(here("Data", "raw_data", "cpue.csv"), na.strings = c("NA", "ND"))
